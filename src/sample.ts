 ...
 * generated from whichever instrument file `@/lib/instrument` currently points
 * at (v2 as of this writing) at render time, so the moment a researcher adds,
 * removes or re-tiers an item, the tour and the landing page show the new
